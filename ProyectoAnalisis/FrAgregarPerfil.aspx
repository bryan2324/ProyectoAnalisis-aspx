<%@ Page Title="" Language="C#" MasterPageFile="~/Index.Master" AutoEventWireup="true" CodeBehind="FrAgregarPerfil.aspx.cs" Inherits="ProyectoAnalisis.FrAgregarPerfil" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <form runat="server" id="Formulario1" class="form-group">
        ...
        <div class="form-label-group form-group">
            <input type="text" id="nombreFront" runat="server" class="input-group-sm" autofocus="autofocus">
            <label for="nombreFront">Nombre</label>
        ...
        <div class="form-label-group form-group">
            ...
            <label for="apellidosFront">Apellidos</label>
        ...
        <%--        <asp:RequiredFieldValidator ID="rfvNaci" runat="server" ControlToValidate="fechaFront" ErrorMessage="*Fecha nacimiento requerida" ForeColor="Red" ValidationGroup="frPerfil"></asp:RequiredFieldValidator>--%>

        <br />
        <br />
        <div class="form-label-group form-group">
            <input type="Number" id="telefonoFront" runat="server" class="input-group-lg" autofocus="autofocus">
            <label for="telefonoFront">Telefono</label>
        ...
        <div class="form-label-group form-group">
            ...
            <label for="DireccionFront">Direccion</label>
        ...
        <hr />
        <asp:Button ID="AgregarPerfil" runat="server" Text="AgregarPerfil" CssClass="btn-primary btn-lg " OnClick="AgregarPerfil_Click" ValidationGroup="frPerfil" />
        <br />
    ...
    <a href="FrMiPerfilProfesional.aspx" id="linkbtn" runat="server" visible="false">
        <br />
        <br />
        <input type="button" value="Ver mi perfil " class="btn-primary" />
    </a>
