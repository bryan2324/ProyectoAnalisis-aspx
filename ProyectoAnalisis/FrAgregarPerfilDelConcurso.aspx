<%@ Page Title="" Language="C#" MasterPageFile="~/IndexAdmin.Master" AutoEventWireup="true" CodeBehind="FrAgregarPerfilDelConcurso.aspx.cs" Inherits="ProyectoAnalisis.FrAgregarPerfilDelConcurso" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <form runat="server" id="Formulario1" class="form-group" cols="20">
                ...
                <asp:Panel ID="paPuesto" runat="server" Style="display: none" CssClass="modalPopup">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <asp:Label runat="server" ID="labelVerificarPuesto" CssClass="text-danger text-center" Visible="false">*El puesto ya existe</asp:Label>
                        </div>
        ...
        <br />
        <div class="form-label-group form-group">
            <input type="text" id="descripcionFront" runat="server" required="required" class="input-group-sm">
        ...
        <asp:Button ID="AgregarPerfilDelConcurso" runat="server" Text="Agregar Concurso" CssClass="btn-primary btn-lg " OnClick="AgregarPerfilDelConcurso_Click" ValidationGroup="frConcurso" />
        <br />
        <asp:Label ID="labelMensaje" runat="server" Text="Perfil del Concurso agregado exitosamente" CssClass="alert-success" Visible="false"></asp:Label>
        <br />
    </form>
