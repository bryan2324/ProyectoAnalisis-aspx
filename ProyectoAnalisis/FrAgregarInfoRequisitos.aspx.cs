...
{
    public partial class FrInfoRequisitos : System.Web.UI.Page
    {
        InfoRequisitos requi;
        InfoIdioma idiom;
        InfoGradoEstudio grado;
        InfoHabilidad habi;
        Carrera carr;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                //se validad que haya un inicio de seccion valido
