...
{
    public partial class FrEditarMiPerfil : System.Web.UI.Page
    {
...
protected void AgregarPerfil_Click(object sender, EventArgs e)
{
    ...
    idUsuario = Convert.ToInt32(query.First());
            ...
            int idperfil;
            idperfil = Convert.ToInt32(query2.First());

            perfilpersona.idPerfilProfesional = idperfil;
    ...
    SIRESEP.BS.Clases.ManPerfilPersona._Instancia.Actualizar(perfilpersona);
